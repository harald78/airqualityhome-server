...
INSERT INTO airqualityhome.aq_user (email, name, created, updated, password)
    values ('default@default.de', 'default', now(), now(), '$2b$12$rhti4e5sO6VCewjLxb5pJenr4bdeqEBYqSOUDuxA.qwiBOkq8kEG.');

INSERT INTO airqualityhome.sensor_base (id, name, created, updated)
...
INSERT INTO airqualityhome.sensor_base_sensor_type (sensor_base_id, sensor_type_id, created, updated)
    values (1, 1, now(), now());
